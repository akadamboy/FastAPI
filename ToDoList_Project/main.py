...
# -------------------------------------------------------------#
#all the below code is commented to implement routing and make the code clean
...
# #We can use both the method to delte items from db
# # if you want to bulk delete the first method will be faster than passing the whole model to the delete function
